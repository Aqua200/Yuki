...
let handler = async (_0x1f703f, {
  ...
  if (!global.db.data.settings[_0x4d3e5b.user.jid].jadibotmd) {
    return _0x4d3e5b.reply(_0x1f703f.chat, "Lo siento este Comando está deshabilitado por mi creador💔.", _0x1f703f, rcanal);
  }
  ...
  exec(_0x188c2.toString("utf-8"), async (_0x175495, _0x5034dc, _0x340928) => {
    ...
    async function _0x3d0599() {
      ...
      const _0x63e935 = {
        ...
        'browser': _0x3f86eb ? ["Ubuntu", "Chrome", "110.0.5585.95"] : ["ᥫ᭡ 🦋𝐀𝐧𝐢𝐤𝐚-𝐒𝐭𝐞𝐥𝐥𝐚✨ (Sub Bot)", "Chrome", '2.0.0'],
        'defaultQueryTimeoutMs': undefined,
        'getMessage': async _0x5bf562 => {
          if (store) {}
          return {
            'conversation': "ᥫ᭡ 🦋𝐀𝐧𝐢𝐤𝐚-𝐒𝐭𝐞𝐥𝐥𝐚✨"
          };
        }
      };
